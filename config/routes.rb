Osb::Application.routes.draw do
  ...
  scope "(:locale)" do
    ...
    # In fact, students and parents are clients
    get '/parents', to: 'clients#parents', as: :parents, defaults: {type: 'parent'}
    ...
    get '/parents/undo_actions', to: 'clients#undo_actions', as: :undo_actions_parents, defaults: {type: 'parent'}

    get '/students', to: 'clients#students', as: :students, defaults: {type: 'student'}
    ...
    post '/students/import_parents_and_students', to: 'clients#import_parents_and_students', as: :import_parents_and_students, defaults: {type: 'student'}
